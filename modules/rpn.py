...
import utils.rpn_utils as det_utils     # BUG
from modules.default_cfg import RPN_CFG
...
class RPN(torch.nn.Module):
    ...
    def __init__(self, out_channels = 256):
        ...
        self.head             = RPNHead(out_channels, len(RPN_CFG['aspect_ratio'][0]))

        self.box_coder        = det_utils.BoxCoder(weights=(1.0, 1.0, 1.0, 1.0))

        self.box_similarity   = box_ops.box_iou  # used during training
